...
[sem-sync](../README.md) / SemaphoreTimeoutError

# Class: SemaphoreTimeoutError
...
> **new SemaphoreTimeoutError**(`message`): `SemaphoreTimeoutError`
...
Descriptive error message explaining the timeout.
