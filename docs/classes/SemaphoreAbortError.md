...
[sem-sync](../README.md) / SemaphoreAbortError

# Class: SemaphoreAbortError
...
> **new SemaphoreAbortError**(`message`): `SemaphoreAbortError`
...
Descriptive error message explaining the abort.
